...
describe('server endpoints Test',()=>{
  ...
  test("it should get an array of reviews for endpoint '/api/reviews/:listingId'", async(done)=>{
  ...
  test("it should get an average score of review for the listingId when endpoint query contains type=review", async(done)=>{
  ...
  xtest("it should give an array length of 12 with each index consisting of suggested listingId information", async(done) =>{
  ...
  test("it should get average review score for array of listIds requested as req.query.array", async(done) =>{
